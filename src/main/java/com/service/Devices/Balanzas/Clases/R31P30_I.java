...
private final Context context;
    ...
    public R31P30(Context context, PuertosSerie serialPort, MainActivity activity,int numero) {
        ...
        public void run() {
                ...
                try {
                    if(serialPort.HabilitadoLectura()){
                                ...
                                if(array.length>0){
                                    ...
                                    if(Utils.isNumeric(read2)){
                                        ...
                                        if(TaraDigital !=0){
                                            NetoStr =read2;
                                            BigDecimal number = new BigDecimal(NetoStr);
                                            NetoStr = Utils.removeLeadingZeros(number);
                                            Neto=Float.parseFloat(read2);
                                            Bruto=Neto+ TaraDigital;
                                            BrutoStr =String.valueOf(Bruto);
                                            if(index==-1){
                       ...
                       // NetoStr ="000000"; // POSIBLE ERROR FIJARSE CON UNA OHAUS
                       // BrutoStr ="000000";
...
//    public void setPesoBandaCero(float peso){
//        pesoBandaCero=peso;
//        SharedPreferences preferencias=activity.getSharedºPreferences(NOMBRE, Context.MODE_PRIVATE);
//        SharedPreferences.Editor ObjEditor=preferencias.edit();
//        ObjEditor.putFloat("pbandacero", peso);
//        ObjEditor.apply();
//    }
